export class RenderUI {
    ...
    updateUI() {
        ...
        this.game.screen.drawRectRound(this.posLeftY - 32, 10, 64, 40, 20, "rgba(38,38,38,0.7)");
        this.game.screen.get("ui").print( this.posLeftY - 6, 38, this.game.player1.score, "#52C5D4");

        this.game.screen.drawRectRound(this.posRightY - 32, 10, 64, 40, 20, "rgba(38,38,38,0.7)");
